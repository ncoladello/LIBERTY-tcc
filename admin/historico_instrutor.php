...
<link rel="stylesheet" type="text/css" href="css/historico_do_instrutor.css"/>
...
?>
   <table width="900" border="0">
    ...
    <tr>
      <td><h2><strong>Treinos que este instrutor aplica:</strong> <?php $sql_2 = "SELECT * FROM treinos WHERE instrutor = '$code'";
    ...
    <tr>
      <td><h3><?php echo $res_2['aula']; ?></h3></td>
      <td><h3><?php echo $res_2['treino']; ?></h3></td>
    </tr>
    <?php } ?>
  </table>
<?php } ?>  
