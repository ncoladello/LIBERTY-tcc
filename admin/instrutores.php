...
<link rel="stylesheet" type="text/css" href="css/instrutores.css"/>
</head>
...
<!EXIBIR TABELA DOS INSTRUTORES CADASTRADOS>
...
<div id="box_instrutores">
<br /><br />
<a class="a2" href="instrutores.php?pg=cadastra">Cadastrar Instrutor</a>
<h1>Instrutores</h1>
<?php
$sql = "SELECT * FROM instrutores WHERE nome != ''";
$con = mysqli_query($conexao, $sql);
if(mysqli_num_rows($con) == ''){
	echo "No momento não existe instrutores cadastrados!";
}else{
?>
    <table width="900" border="0">
      <tr>
        ...
        <td><strong>Nº treino(s):</strong></td>
      ...
      <tr>
        ...
        <td><h3><?php 
		$sql2 = "SELECT * FROM treinos WHERE instrutor = '$code'";
        ...
        <td></td>
        <td>
        <a class="a" href="instrutores.php?pg=todos&func=deleta&id=<?php echo $res_1['id']; ?>"><img title="Excluir Instrutor" src="img/deleta.jpg" width="18" height="18" border="0"></a>
        <?php if($res_1['status'] == 'Inativo'){?>
        <a class="a" href="instrutores.php?pg=todos&func=ativa&id=<?php echo $res_1['id']; ?>&code=<?php echo $res_1['code']; ?>"><img title="Ativar novamente instrutor" src="../img/correto.jpg" width="20" height="20" border="0"></a>
        <?php } ?>
        <?php if($res_1['status'] == 'Ativo'){?>
        <a class="a" href="instrutores.php?pg=todos&func=inativa&id=<?php echo $res_1['id']; ?>&code=<?php echo $res_1['code']; ?>"><img title="Inativar Instrutor(a)" src="../img/ico_bloqueado.png" width="18" height="18" border="0"></a>
        <?php } ?>
        <a class="a" href="instrutores.php?pg=todos&func=edita&id=<?php echo $res_1['id']; ?>"><img title="Editar Dados Cadastrais" src="../img/ico-editar.png" width="18" height="18" border="0"></a>
        <a class="a" rel="superbox[iframe][930x500]" href="historico_instrutor.php?id=<?php echo $res_1['id']; ?>"><img title="Histórico deste instrutor" src="../img/visualizar16.gif" width="18" height="18" border="0"></a></td>
      </tr>
      <?php } ?>
    </table>
<?php  }?>
...
$sql_del = "DELETE FROM instrutores WHERE id = '$id'";
mysqli_query($conexao, $sql_del);
echo "<script language='javascript'>window.location='instrutores.php?pg=todos';</script>";
...
$sql_edit1 = "UPDATE instrutores SET status = 'Ativo' WHERE id = '$id'";
...
$sql_edit3 = "UPDATE instrutores SET status = 'Inativo' WHERE id = '$id'";
...
$sql_1 = "SELECT * FROM instrutores WHERE id = '$id'";
...
$sql_2 = "UPDATE instrutores SET nome = '$nome', cpf = '$cpf', nascimento = '$nascimento', formacao = '$formacao', graduacao = '$graduacao', pos_graduacao = '$pos_graduacao', mestrado = '$mestrado', doutorado = '$doutorado', salario = '$salario' WHERE id = '$id'";
...
if($res_editar == ''){
	...
	echo "<script language='javascript'>window.alert('Atualização realizada com sucesso!');window.location='instrutores.php?pg=todos';</script>";
...
$sql_2 = "INSERT INTO instrutores (code, status, nome, cpf, nascimento, formacao, graduacao, pos_graduacao, mestrado, doutorado, salario) VALUES ('$code', 'Ativo', '$nome', '$cpf', '$nascimento', '$formacao', '$graduacao', '$pos_graduacao', '$mestrado', '$doutorado', '$salario')";
$cadastra = mysqli_query($conexao, $sql_2);
if($cadastra == ''){
	echo "<script language='javascript'>window.alert('Ocorreu um erro ao cadastrar!');</script>";
}else{
	
$sql_3 = "INSERT INTO login (status, code, senha, nome, painel) VALUES ('Ativo', '$code', '$cpf', '$nome', 'instrutor')";
$cadastra_login = mysqli_query($conexao, $sql_3);

	echo "<script language='javascript'>window.alert('Instrutor cadastrado com sucesso!');window.location='instrutores.php?pg=todos';</script>";
 }
}?>
...
<form name="form1" method="post" action="">
  <table width="900" border="0">
    ...
    <tr>
      <td>
      <?php
      $sql_4 = "SELECT * FROM instrutores ORDER BY id DESC LIMIT 1";
